...
namespace Runge_Kutta_method
{
    internal class TRunge_Kutta_method
    {
        ...
        void Method()
        {
            ...
            double[] vector_original_y = new double[k];
            double [] vector_Eps = new double[k];
            vector_x[0] = x;
            vector_y[0] = y;
            double h = 0.1;
            double delta_Y;
            ...
            while (x < 0.95)
            {
                ...
                y += delta_Y;
                Console.WriteLine(" delta Y = " + delta_Y);
                x += h;
            ...
            Console.WriteLine("Vector original Y:");
            PrintVector(vector_original_y);
            Console.WriteLine("Vector Eps:");
